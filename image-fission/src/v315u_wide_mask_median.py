"""
v315u: wide mask (gray<180) + median+noise fill.

v315q used gray<100 → anti-aliased edges of original text remained as
faint ghost shadows. v315u widens the mask to gray<180 to catch the
soft edges.

This may slightly increase the "patch" effect (more pixels filled with
flat median), but eliminates the ghost shadows completely.
"""
import cv2
import numpy as np
...
for band in BANDS:
    ...
    # Wider mask: gray<180 catches anti-aliased edges of text
