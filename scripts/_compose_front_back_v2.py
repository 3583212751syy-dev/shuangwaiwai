...
OUT_DIR = "E:/Desktop/茶叶/成品_第十一轮_正背组合重制"
...
SCENES = [
    ("E:/Desktop/茶叶/成品_第十轮_正背组合图/_assets/Commercial_product_photography_2026-07-21T09-24-18.png",
     ...
     {"size": 300, "x": 970, "y": 490, "bright": 1.05, "alpha": 1.0}),
...
for bg_path, out_name, fcfg, bcfg in SCENES:
    ...
    # Back shadow (softer, lighter because it's behind)
    back_shadow = add_shadow_layer((W, H), bcfg["x"], bcfg["y"], bw, bh, 45, blur=20)
