...
SCENES = [
    ("E:/Desktop/茶叶/成品_第八轮_主图场景样稿/_assets/Frontal_commercial_product_pho_2026-07-21T08-35-54.png",
     "01_iced_refresh.png", 430, 280, 740, 1.04, 1.0, 50, (8, 16), 14),
    ("E:/Desktop/茶叶/成品_第八轮_主图场景样稿/_assets/Frontal_outdoor_lifestyle_prod_2026-07-21T08-35-55.png",
     "02_lifestyle_garden.png", 480, 520, 720, 1.05, 1.03, 55, (12, 22), 16),
    ("E:/Desktop/茶叶/成品_第八轮_主图场景样稿/_assets/Frontal_premium_dark_ingredien_2026-07-21T08-35-54.png",
     "03_ingredients_dark.png", 460, 512, 720, 0.96, 0.98, 90, (10, 18), 16),
    ("E:/Desktop/茶叶/成品_第八轮_主图场景样稿/_assets/Frontal_cinematic_origin_produ_2026-07-21T08-35-54.png",
     "04_origin_farm.png", 470, 512, 720, 1.0, 1.02, 55, (12, 20), 15),
]
...
def add_shadow(bg, cx, cy, w, h, alpha, offset, blur):
    ...
    cdraw.ellipse([cx - w//2.2, cy - h//12, cx + w//2.2, cy + h//12], fill=(0,0,0,int(alpha*0.5)))
...
for bg_path, out_name, size, cx, cy_ground, bright, warm, shadow_alpha, shadow_offset, shadow_blur in SCENES:
    ...
    bg = add_shadow(bg, cx, cy_ground, int(prod.width * 0.85), int(size * 0.2), shadow_alpha, shadow_offset, shadow_blur)
